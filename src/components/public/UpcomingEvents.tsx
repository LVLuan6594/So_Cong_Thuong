...
export function UpcomingEvents({ events }: { events: PortalPost[] }) {
  return (
    <section id="su-kien" className="bg-surface py-16">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {events.map((e) => {
            ...
            return (
              ...
              >
                <div className="flex items-center gap-4 border-b border-border bg-gradient-to-r from-navy to-gov p-5 text-white">
                  <div className="grid size-16 shrink-0 place-items-center rounded-xl bg-white/15">
