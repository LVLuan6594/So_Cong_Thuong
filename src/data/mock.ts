...
export const CLUSTER_FACTORIES: Record<string, Factory[]> = {
  "ccn-01": [
    {
      id: "f-0101",
      name: "Công ty TNHH Cơ khí Trảng Bàng",
      sector: "Cơ khí",
      address: "Lô A1 – CCN Trảng Bàng",
      representative: "Nguyễn Văn Hùng",
      area: 3.2,
      employees: 320,
      products: "Kết cấu thép, chi tiết máy",
      revenue: 86.4,
      status: "active",
      lat: 11.0248,
      lng: 106.3772,
      taxCode: "3900101011",
      establishedAt: "12/03/2015",
      legalType: "Công ty TNHH 1 thành viên",
      sectorSecondary: "Điện tử",
      investment: 45,
      ward: "Phường An Hòa",
      phone: "0276 3845 901",
      email: "contact@cokhitrangbang.vn",
      website: "https://cokhitrangbang.vn",
    },
    {
      id: "f-0102",
      name: "Công ty TNHH Điện tử Trảng Bàng",
      sector: "Điện tử",
      address: "Lô B2 – CCN Trảng Bàng",
      representative: "Trần Minh Quang",
      area: 2.6,
      employees: 540,
      products: "Bo mạch điện tử dân dụng",
      revenue: 174.5,
      status: "active",
      lat: 11.0272,
      lng: 106.3801,
    ...
    {
      id: "f-0104",
      name: "Công ty CP Dệt may Trảng Bàng",
      sector: "Dệt may",
      address: "Lô D4 – CCN Trảng Bàng",
      representative: "Phạm Thị Lan",
      area: 3.8,
      employees: 760,
      products: "Vải dệt kim, sợi",
      revenue: 142.9,
      status: "expanding",
      lat: 11.0284,
      lng: 106.3753,
    ...
    {
      id: "f-0105",
      name: "Nhà máy Gia công Cơ khí Đông Á",
      sector: "Cơ khí",
      address: "Lô E5 – CCN Trảng Bàng",
      representative: "Hoàng Đức Anh",
      area: 1.4,
      employees: 95,
      products: "Linh kiện cơ khí chính xác",
      revenue: 32.1,
      status: "suspended",
      lat: 11.0269,
      lng: 106.3789,
  ...
  "ccn-02": [
    {
      ...
      name: "Công ty CP Cơ khí Đông Nam",
      sector: "Cơ khí",
      address: "Lô A1 – CCN Bến Cầu",
      representative: "Lê Văn Dũng",
      area: 4.1,
      employees: 410,
      products: "Máy móc, thiết bị công nghiệp",
      revenue: 86.1,
      status: "active",
      lat: 11.1332,
      lng: 106.1191,
      ...
      ward: "Xã Long Khánh",
      phone: "0276 3821 733",
      email: "info@cokhidongnam.vn",
      website: "https://cokhidongnam.vn",
    },
    {
      id: "f-0202",
      name: "Nhà máy Dệt nhuộm Bến Cầu",
      sector: "Dệt may",
      address: "Lô B2 – CCN Bến Cầu",
      representative: "Nguyễn Thị Hồng",
      area: 2.9,
      employees: 285,
      products: "Vải nhuộm hoàn tất",
      revenue: 58.3,
      status: "active",
      lat: 11.1353,
      lng: 106.1219,
    ...
    {
      id: "f-0203",
      name: "Công ty TNHH Kết cấu thép Nam Sông",
      sector: "Cơ khí",
      address: "Lô C3 – CCN Bến Cầu",
    ...
    {
      id: "f-0204",
      name: "Nhà máy Dệt may Bến Cầu - Vinatex",
      sector: "Dệt may",
      address: "Lô D4 – CCN Bến Cầu",
  ...
  "ccn-03": [
    {
      id: "f-0301",
      name: "Nhà máy Chế biến Cao su Gò Dầu",
      sector: "Cao su",
      address: "Lô A1 – CCN Gò Dầu",
      representative: "Nguyễn Văn Tâm",
      area: 4.6,
      employees: 380,
      products: "Cao su khối SVR 3L, mủ tờ",
      revenue: 128.4,
      status: "active",
      lat: 11.1563,
      lng: 106.2544,
      taxCode: "3900303033",
      establishedAt: "20/01/2010",
      legalType: "Doanh nghiệp nhà nước",
      sectorSecondary: "Chế biến nông sản",
      investment: 88,
      ward: "Xã Phước Đông",
      phone: "0276 3847 812",
      email: "info@caosugodau.vn",
      website: "https://caosugodau.vn",
    },
    {
      id: "f-0302",
      name: "Nhà máy Sơ chế Nông sản Gò Dầu",
      sector: "Chế biến nông sản",
      address: "Lô B2 – CCN Gò Dầu",
      representative: "Trần Thị Hạnh",
      area: 2.2,
      employees: 160,
      products: "Hạt điều nhân, bắp non",
      revenue: 55.6,
      status: "active",
      lat: 11.1586,
      lng: 106.2565,
    },
    {
      ...
      name: "Công ty CP Cao su Tây Ninh Phát",
      sector: "Cao su",
      address: "Lô C3 – CCN Gò Dầu",
      representative: "Phạm Đức Duy",
      area: 3.1,
      employees: 240,
      products: "Cao su latex, mủ cốm",
      revenue: 97.2,
      status: "expanding",
      lat: 11.1572,
      lng: 106.2551,
    ...
    {
      id: "f-0304",
      name: "Nhà máy Tinh bột Osh có dầu Gò Dầu",
      sector: "Chế biến nông sản",
      address: "Lô D4 – CCN Gò Dầu",
      representative: "Lê Thị Thu",
      area: 1.9,
      employees: 130,
      products: "Tinh bột sắn, bột ngọt nhạt",
      revenue: 32.8,
      status: "suspended",
      lat: 11.1592,
      lng: 106.2549,
  ...
  "ccn-04": [
    {
      ...
      sector: "Năng lượng",
      address: "Lô A1 – CCN Tân Biên",
      representative: "Trần Quang Vinh",
      area: 42,
      employees: 45,
      products: "Điện mặt trời 120 MW",
      revenue: 168,
      status: "active",
      lat: 11.5876,
      lng: 105.9585,
    ...
    {
      id: "f-0402",
      name: "Nhà máy Sinh khối Tân Biên",
      sector: "Năng lượng",
      address: "Lô B2 – CCN Tân Biên",
      representative: "Nguyễn Thị Lan",
      area: 8,
      employees: 90,
      products: "Điện sinh khối từ trấu",
      revenue: 76.5,
      status: "expanding",
      lat: 11.5898,
      lng: 105.9608,
    ...
    {
      id: "f-0403",
      name: "Công ty TNHH Chế biến Gỗ Tân Biên",
      sector: "Chế biến nông sản",
      address: "Lô C3 – CCN Tân Biên",
      representative: "Lê Văn Sơn",
      area: 2.4,
      employees: 110,
      products: "Viên nén gỗ, ván ép",
      revenue: 28.9,
      status: "active",
      lat: 11.5882,
      lng: 105.9589,
  ...
  "ccn-05": [
    {
      ...
      name: "Công ty TNHH Dệt may Châu Thành",
      sector: "Dệt may",
      address: "Lô A1 – CCN Châu Thành",
      representative: "Lê Văn Cường",
      area: 3.5,
      employees: 640,
      products: "Vải dệt kim, hàng may mặc",
      revenue: 142.9,
      status: "active",
      lat: 11.3142,
      lng: 106.0171,
    ...
    {
      id: "f-0502",
      name: "Nhà máy Cơ khí Châu Thành",
      sector: "Cơ khí",
      address: "Lô B2 – CCN Châu Thành",
      representative: "Trần Anh Tuấn",
      area: 2.8,
      employees: 210,
      products: "Máy ép, máy dập",
      revenue: 52.3,
      status: "active",
      lat: 11.3164,
      lng: 106.0194,
    ...
    {
      id: "f-0503",
      name: "Công ty TNHH May mặc Xuất khẩu Châu Thành",
      sector: "Dệt may",
      address: "Lô C3 – CCN Châu Thành",
      representative: "Hoàng Thị Ngân",
      area: 3,
      employees: 580,
      products: "Áo jacket, quần âu xuất khẩu",
      revenue: 118.6,
      status: "expanding",
      lat: 11.3153,
      lng: 106.0173,
  ...
  "ccn-06": [
    {
      id: "f-0601",
      name: "Tổ hợp Thương mại – Điện tử TP. Tây Ninh",
      sector: "Điện tử",
      address: "Lô A1 – CCN TP. Tây Ninh",
      representative: "Nguyễn Văn Khải",
      area: 1.8,
      employees: 310,
      products: "Linh kiện điện tử tiêu dùng",
      revenue: 88.4,
      status: "active",
      lat: 11.3054,
      lng: 106.0973,
      taxCode: "3900606066",
      establishedAt: "15/05/2019",
      legalType: "Công ty TNHH 2 thành viên",
      sectorSecondary: "Thương mại",
      investment: 38,
      ward: "Phường 3",
      phone: "0276 3820 144",
      email: "info@thuongmaitn.vn",
      website: "https://thuongmaitayninhtp.vn",
    },
    {
      id: "f-0602",
      name: "Trung tâm Logistics & Thương mại Tây Ninh",
      sector: "Thương mại",
      address: "Lô B2 – CCN TP. Tây Ninh",
      representative: "Trần Thị Kim Oanh",
      area: 4.2,
      employees: 140,
      products: "Kho bãi, phân phối hàng hóa",
      revenue: 74.9,
      status: "active",
      lat: 11.3081,
      lng: 106.0995,
    ...
    {
      id: "f-0603",
      name: "Công ty CP Điện tử Viễn thông Tây Ninh",
      sector: "Điện tử",
      address: "Lô C3 – CCN TP. Tây Ninh",
      representative: "Lê Đình Phương",
      area: 1.5,
      employees: 95,
      products: "Bộ đàm, thiết bị viễn thông",
      revenue: 45.7,
      status: "suspended",
      lat: 11.3073,
      lng: 106.0968,
